# taste-skill reference: Aesthetics, Directives & AI Tells

> Part of `taste-skill`. Section numbering is preserved from the original SKILL.md, so cross-references like "Section 4.2" or "Section 9.G" resolve here. Read this before writing any code.

## 1. THE THREE DIALS - Inference Tables

The dials summary and baseline live in SKILL.md Section 1. These are the tables it points at.
