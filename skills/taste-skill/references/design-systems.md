# taste-skill reference: Design Systems & Package Maps

> Part of `taste-skill`. Section and appendix numbering is preserved from the original SKILL.md, so cross-references like "Section 2.A" resolve here. Read this right after the design read, when picking the foundation.
