# taste-skill reference: Motion & Scroll Code Skeletons

> Part of `taste-skill`. Section numbering is preserved from the original SKILL.md, so cross-references like "Section 5.A" resolve here. Read this when the design read calls for motion, scroll-hijack, glass, or micro-physics. (Section 3.B lives in `aesthetics.md`; the Pre-Flight Check is Section 14 in SKILL.md.)
