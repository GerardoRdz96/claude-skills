---
name: onboard
description: Use ONLY inside a freshly cloned aios-starter-kit clone (the repo has aios-intake.md and a CLAUDE.md with {{...}} placeholders) — NEVER in Servy or any already-onboarded AIOS. Day 1 of an AIOS install, when someone says "set me up", "onboard me", "let's get started", "fill in my AIOS", or has just cloned the kit. Combined wizard — runs the 7-question intake AND scaffolds the Day-1 file set at the end. Idempotent — re-run any time after editing aios-intake.md.
